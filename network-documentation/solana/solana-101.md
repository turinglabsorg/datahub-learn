...
1. **Code in your language:** Solana programs can be written in Rust, C or C++ but you can use any language that support JSON to interact with them at the dApp layer. Solana has SDKs built for Javascript, Python, Java, C\# and more are coming!
