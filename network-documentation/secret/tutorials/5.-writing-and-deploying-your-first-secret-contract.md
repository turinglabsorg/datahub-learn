...
# 5. Writing and deploying your first Secret contract
...
1. [Connecting to a Secret Network node with DataHub](https://github.com/figment-networks/datahub-learn/tree/b00d63c166d6206682f4b45402b6ee81d2e8cd11/network-documentation/secret/tutorials/1.-connecting-to-a-secret-node-using-datahub)
2. [Creating your first Secret Network account](2.-setting-up-your-wallet.md)
3. [Querying the Secret Network](https://github.com/figment-networks/datahub-learn/tree/b00d63c166d6206682f4b45402b6ee81d2e8cd11/network-documentation/secret/tutorials/3.-querying-the-secret-blockchain)
4. [Submitting your first transaction](https://github.com/figment-networks/datahub-learn/tree/b00d63c166d6206682f4b45402b6ee81d2e8cd11/network-documentation/secret/tutorials/4.-submit-your-first-transaction)
