...
In this tutorial, we will learn how to create a simple contract using Rust, compile it to WASM binary and deploy to Secret Network using a [DataHub](https://datahub.figment.io/sign_up?service=secret) node.
...
2. [Setting up your wallet](2.-setting-up-your-wallet.md)
...
Great job! We have successfully compiled our first smart contract into a WebAssembly binary and ready to deploy it to the Secret Network using DataHub.
...
```
Unlike before, we didn't use CosmWasmClient to connect to Secret Network, instead we used SigningCosmWasmClient, the bigger brother of CosmWasmClient with signing capability to interact with a CosmWasm blockchain.
...
```
----------------------------------------------------------------
OPEN LINKS BELOW to see the transactions in Secret Explorer!
https://explorer.secrettestnet.io/transactions/E201BBC45316985C6FAED52BA02102734AA597EA9A54E5B4DD99B65D74AACBF2
https://explorer.secrettestnet.io/transactions/6620088CA59078843A367B96E6C468CB5E2100CE497D45F786BBBC5C4EE74BD0
