...
## Get WND tokens from the Figment faucet
...
WND tokens can be obtained from the Figment Learn faucet or the official Polkadot faucet. Just go to [https://faucet.figment.io/](https://faucet.figment.io/), signup with yoru DataHub account and paste the address you've saved in your `.env` file
...
Create a `transfer.js` file and place the following code within :
