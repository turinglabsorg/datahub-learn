...
WND tokens can be obtained from the Figment Learn faucet or the official Polkadot faucet. Go to [https://faucet.figment.io/](https://faucet.figment.io/), sign in with a DataHub account and then paste the address you've saved in your `.env` file into the text input :
