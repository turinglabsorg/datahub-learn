...
All tutorials in the Polkadot Learn pathway require at least version 12.x of Node.js, however there might be specific compatibility issues if you're using the most recent release like 15.x. Where applicable, we will highlight these differences.
