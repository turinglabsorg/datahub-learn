...
{% hint style="info" %}
f you prefer going through the tutorial with a video, [**check out this walkthrough**](https://www.youtube.com/watch?v=3VJyk669O-k&feature=emb_title) created by community member Psychotropic Picnic!
{% endhint %}
