...
{% hint style="warning" %}
If you're getting an in`npm install --save @celo/contractkit dotenv web3`then check our forum for a possible solution. [Check Here](https://community.figment.io/t/celo-tutorial-errors-issues/65)
{% endhint %}
