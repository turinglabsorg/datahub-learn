...
* 1. Creating your first Celo account
...
Now let’s break it down a little bit. Once we create a new client using `newKit` we need to initialise our account. Luckily, our `.env` file holds all the information we need to do just that. This line:
