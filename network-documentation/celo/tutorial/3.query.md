...
{% hint style="info" %}
If you prefer going through the tutorial with a video, [**check out this walkthrough**](https://youtu.be/u0lC1g966oo) created by our community member **Chris Wilson**
{% endhint %}
