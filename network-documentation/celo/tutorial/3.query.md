...
{% hint style="info" %}
If you prefer going through the tutorial with a video, [**check out this walkthrough**](https://youtu.be/ljt-_dxpqLU?list=PLkgTdjgP1aUCmcXrTxyRReS5OSLXlqGzB) created by our community member **Chris Wilson**
{% endhint %}
