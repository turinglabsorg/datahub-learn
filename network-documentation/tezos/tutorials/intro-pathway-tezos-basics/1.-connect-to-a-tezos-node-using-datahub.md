...
We will be interacting with the Tezos blockchain via the DataHub infrastructure. This saves developers time and expense of dealing with the often very particular and time-consuming work of keeping the hardware and software working together, maintaining optimal uptime for a node. 

The Taquito toolkit is used in this tutorial because it offers all the necessary functionality to interact with Tezos. Taquito offers an RPC package, a batch API, 
