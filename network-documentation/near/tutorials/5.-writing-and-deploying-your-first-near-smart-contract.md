...
In this tutorial, we will learn how to create a simple contract using the NEAR SDK for AssemblyScript Contracts, compile it to WASM binary and deploy it to NEAR testnet using [DataHub](https://datahub.figment.io/sign_up?service=near).
