...
If we encounter an error such as this :

```bash
2021-04-22 17:55:36        API/INIT: Api will be available in a limited mode since the provider does not support subscriptions
2021-04-22 17:55:36        RPC-CORE: getBlockHash(blockNumber?: BlockNumber): BlockHash:: request to http://127.0.0.1:9933/ failed, reason: connect ECONNREFUSED 127.0.0.1:9933
2021-04-22 17:55:36        API/INIT: Error: FATAL: Unable to initialize the API: request to http://127.0.0.1:9933/ failed, reason: connect ECONNREFUSED 127.0.0.1:9933
    at ApiPromise.value (/home/username/projects/polkadot/node_modules/@polkadot/api/base/Init.cjs:91:25)
    at processTicksAndRejections (node:internal/process/task_queues:96:5)
2021-04-22 17:55:36        API/INIT: FetchError: request to http://127.0.0.1:9933/ failed, reason: connect ECONNREFUSED 127.0.0.1:9933
    at ClientRequest.<anonymous> (/home/username/projects/polkadot/node_modules/node-fetch/lib/index.js:1461:11)
...
2021-04-22 17:55:36        RPC-CORE: getRuntimeVersion(at?: BlockHash): RuntimeVersion:: request to http://127.0.0.1:9933/ failed, reason: connect ECONNREFUSED 127.0.0.1:9933
2021-04-22 17:55:36        RPC-CORE: chain(): Text:: request to http://127.0.0.1:9933/ failed, reason: connect ECONNREFUSED 127.0.0.1:9933
2021-04-22 17:55:36        RPC-CORE: properties(): ChainProperties:: request to http://127.0.0.1:9933/ failed, reason: connect ECONNREFUSED 127.0.0.1:9933
2021-04-22 17:55:36        RPC-CORE: methods(): RpcMethods:: request to http://127.0.0.1:9933/ failed, reason: connect ECONNREFUSED 127.0.0.1:9933
2021-04-22 17:55:36        RPC-CORE: getMetadata(at?: BlockHash): Metadata:: request to http://127.0.0.1:9933/ failed, reason: connect ECONNREFUSED 127.0.0.1:9933
```

This is a sure sign of a missing environment variable. It is displaying this error because by default, the Polkadot HttpProvider will attempt to connect to localhost on port 9933 - and we are not running a local node. Supplying the DATAHUB\_URL environment variable in `.env` is the solution to this issue.
