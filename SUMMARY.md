...
* [🔋 Solana](network-documentation/solana/README.md)
  ...
  * [🗺 Solana Pathway](network-documentation/solana/intro-pathway-solana-basics/README.md)
    * [👩‍💻 Setup](network-documentation/solana/intro-pathway-solana-basics/setup.md)
    * [1. Connect to the Solana Devnet](network-documentation/solana/intro-pathway-solana-basics/1.-connect-to-solana-devnet-using-datahub.md)
    * [2. Create a Keypair](network-documentation/solana/intro-pathway-solana-basics/2.-create-your-first-solana-account.md)
